  ...
  return `
    ...
    <body>
      <div class="container">
        ...
        <div class="footer">
          <p>Generated by SehatSphere on ${new Date().toLocaleDateString()}</p>
        </div>
      </div>
    </body>
    </html>
...
const createPrescription = asyncHandler(async (req, res) => {
  ...
  if (patient.user) {
      ...
      if (patientUser && patientUser.phoneNumber) {
          const msg = `Hello ${patientUser.name}, you have a new prescription from Dr. ${doctor.user.name}. View it in the SehatSphere app.`;
